...
const PLAIN_CODES = new Set([
  ...
  "category_not_found",
  "task_not_found",
  // Смета: чужая или несуществующая сущность, пустое предложение, которому
  // нечего переносить в план, и смена единицы, после которой число не
  // помещается в колонку строки.
